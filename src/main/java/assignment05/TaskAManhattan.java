 ...
 *
 */
public class TaskAManhattan implements PlugInFilter {

	/**
	 * 
	 * TODO:
	 * 
	 * to make mirroring invariant
	 * 
	 * 4 Histograms vs 1 Histogram
	 * 
	 * 
	 */

	private static final double ERROR_THRESHOLD = 0.46;
